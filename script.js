...
const prompts = [
  "パソコンでのタイピングが速くなると、メール作成や資料作りにかかる時間が大幅に短縮されるため、仕事の効率が向上し、余った時間を学習や趣味に充てることができます。　公共交通機関で席を譲るときは、相手が遠慮しないよう自然な声かけと笑顔を添えることで、心温まるやり取りになり、周囲にも良い雰囲気が広がります。",
  "公共交通機関で席を譲るときは、相手が遠慮しないよう自然な声かけと笑顔を添えることで、心温まるやり取りになり、周囲にも良い雰囲気が広がります。　日本の四季折々の風景は美しく、特に春の桜並木や秋の紅葉は多くの観光客を魅了しますが、地元の人々にとっては幼い頃から馴染みのある心温まる原風景でもあります。",
  ...
  "プログラミングの学習ではエラーと向き合うことが避けられませんが、エラーメッセージを検索して原因を調べ、自分で解決する過程こそがスキルアップにつながります。　パソコンでのタイピングが速くなると、メール作成や資料作りにかかる時間が大幅に短縮されるため、仕事の効率が向上し、余った時間を学習や趣味に充てることができます。",
  "パソコンでのタイピングが速くなると、メール作成や資料作りにかかる時間が大幅に短縮されるため、仕事の効率が向上し、余った時間を学習や趣味に充てることができます。　公共交通機関で席を譲るときは、相手が遠慮しないよう自然な声かけと笑顔を添えることで、心温まるやり取りになり、周囲にも良い雰囲気が広がります。",
  "公共交通機関で席を譲るときは、相手が遠慮しないよう自然な声かけと笑顔を添えることで、心温まるやり取りになり、周囲にも良い雰囲気が広がります。　日本の四季折々の風景は美しく、特に春の桜並木や秋の紅葉は多くの観光客を魅了しますが、地元の人々にとっては幼い頃から馴染みのある心温まる原風景でもあります。",
  "日本の四季折々の風景は美しく、特に春の桜並木や秋の紅葉は多くの観光客を魅了しますが、地元の人々にとっては幼い頃から馴染みのある心温まる原風景でもあります。　新しい言語を学習するとき、毎日少しずつ継続的に練習することが最も効果的であり、短期間に詰め込むよりも長期的に記憶が定着しやすくなると言われています。",
  "新しい言語を学習するとき、毎日少しずつ継続的に練習することが最も効果的であり、短期間に詰め込むよりも長期的に記憶が定着しやすくなると言われています。　オンライン会議では発言者以外がマイクをミュートにすることで、不要な雑音を減らし円滑なコミュニケーションを確保できるため、基本的なマナーとして覚えておきましょう。",
...
function finishTest(){
  ...
  const wpm= elapsed>0? ((correctChars/5)/(elapsed/60)).toFixed(1):0;
  resultEl.innerHTML=`正確さ: ${accuracy}% | WPM: ${wpm}`;
  startBtn.disabled=false;
}

function getCorrectCharCount(p,t){
  let c=0;
  for(let i=0;i<Math.min(p.length,t.length);i++){ if(p[i]===t[i]) c++; }
  return c;
}
